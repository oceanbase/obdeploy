...
cd ${RPM_BUILD_ROOT}/usr/obd/plugins && ln -s oceanbase oceanbase-ce && ln -s oceanbase oceanbase-standalone && ln -s oceanbase oceanbase.ai && ln -s oceanbase-libs oceanbase-standalone-libs && ln -s oceanbase-libs oceanbase-ce-libs && ln -s oceanbase-libs oceanbase.ai-libs && ln -s oceanbase-ce-utils oceanbase-standalone-utils && ln -sf ocp-server ocp-server-ce && ln -s obbinlog-ce obbinlog && \cp -rf obproxy/* obproxy-ce/ && \cp -rf $SRC_DIR/plugins/obproxy-ce/* obproxy-ce/ && ln -sf oms oms-ce
mv obproxy/3.1.0 obproxy/3.2.1
cd ${RPM_BUILD_ROOT}/usr/obd/workflows && ln -s oceanbase oceanbase-ce && ln -s oceanbase oceanbase.ai && ln -s oceanbase oceanbase-standalone && ln -sf ocp-server ocp-server-ce && ln -sf obproxy obproxy-ce && ln -s obbinlog-ce obbinlog && ln -sf oms oms-ce
mv obproxy/3.1.0 obproxy/3.2.1
cd ${RPM_BUILD_ROOT}/usr/obd/config_parser && ln -s oceanbase oceanbase-ce && ln -s oceanbase oceanbase-standalone && ln -s oceanbase oceanbase.ai
