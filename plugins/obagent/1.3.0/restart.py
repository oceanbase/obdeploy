...
class Restart(object):
    ...
    def __init__(self, plugin_context, local_home_path, start_check_plugin, start_plugin, stop_plugin, connect_plugin,
                 display_plugin, repository, new_cluster_config=None, new_clients=None, deploy_name=None):
    ...
    def restart(self):
        ...
        self.call_plugin(self.start_check_plugin, clients=clients, cluster_config=cluster_config)
...
def restart(plugin_context, local_home_path, start_check_plugin, start_plugin, stop_plugin, connect_plugin, display_plugin,
            new_cluster_config=None, new_clients=None, rollback=False, *args, **kwargs):
    repository = kwargs.get('repository')
    deploy_name = plugin_context.deploy_name
    task = Restart(plugin_context=plugin_context, local_home_path=local_home_path, start_plugin=start_plugin,
                   stop_plugin=stop_plugin, connect_plugin=connect_plugin,
                   display_plugin=display_plugin, repository=repository, new_cluster_config=new_cluster_config,
                   new_clients=new_clients, deploy_name=deploy_name, start_check_plugin=start_check_plugin)
