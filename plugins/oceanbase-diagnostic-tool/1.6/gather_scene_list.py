...
def gather_scene_list(plugin_context, *args, **kwargs):
    ...
    def get_obdiag_cmd():
        base_commond=r"cd {install_dir} && ./obdiag gather scene list".format(install_dir=obdiag_install_dir)
        cmd = r"{base}".format(
            base=base_commond,
        )
        return cmd
    ...
    try:
        ...
        stdio.exception("obdiag gather scene list failed")
        return plugin_context.return_false()