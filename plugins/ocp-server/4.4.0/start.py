...
def start(plugin_context, multi_process_flag=False, start_env=None, *args, **kwargs):
    ...
    for server in cluster_config.servers:
        ...
        extra_options_str = '-XX:+ExitOnOutOfMemoryError -XX:+HeapDumpOnOutOfMemoryError -Dfile.encoding=UTF-8 ' \
                            ...
                            '--add-opens=java.base/java.net=ALL-UNNAMED --add-opens=java.base/java.nio.charset=ALL-UNNAMED ' \
                            '--add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/java.security=ALL-UNNAMED ' \
                            '--add-opens=java.base/java.text=ALL-UNNAMED --add-opens=java.base/java.time.format=ALL-UNNAMED ' \
                            '--add-opens=java.base/java.time=ALL-UNNAMED --add-opens=java.base/java.util.concurrent.atomic=ALL-UNNAMED ' \
                            '--add-opens=java.base/java.util.concurrent=ALL-UNNAMED --add-opens=java.base/java.util.regex=ALL-UNNAMED ' \
                            '--add-opens=java.base/java.util.stream=ALL-UNNAMED --add-opens=java.base/java.util=ALL-UNNAMED ' \
                            '--add-opens=java.base/sun.net.www.protocol.https=ALL-UNNAMED --add-opens=java.base/sun.net=ALL-UNNAMED ' \
                            '--add-opens=java.base/sun.nio.cs=ALL-UNNAMED --add-opens=java.base/sun.nio.fs=ALL-UNNAMED ' \
                            '--add-opens=java.base/sun.security.jca=ALL-UNNAMED --add-opens=java.base/sun.security.ssl=ALL-UNNAMED ' \
