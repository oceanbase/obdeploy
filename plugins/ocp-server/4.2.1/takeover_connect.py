...
def takeover_connect(plugin_context, target_server=None, *args, **kwargs):
    ...
    for server in servers:
        cursor = OcpTakeOverCursor(address, user=user, password=password, component_name=cluster_config.name, stdio=stdio)
