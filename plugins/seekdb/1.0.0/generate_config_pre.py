...
def generate_random_password(cluster_config, auto_depend):
    ...
    added_components = {
        ...
        for component in const.COMPS_OB + const.COMPS_ODP + const.COMPS_OCP + [const.COMP_OCP_EXPRESS, const.COMP_OBAGENT, const.COMP_OBLOGPROXY, const.COMP_OBBINLOG_CE, const.COMP_OB_SEEKDB]
    }
    be_depends = {
...
def generate_config_pre(plugin_context, auto_depend=False, *args, **kwargs):
    ...
    plugin_context.set_variable('max_syslog_type_file_count', 1)
