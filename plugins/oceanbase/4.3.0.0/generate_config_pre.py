...
def generate_random_password(cluster_config, auto_depend):
    ...
    added_components = {
        ...
        for component in const.COMPS_OB + const.COMPS_ODP + const.COMPS_OCP + [const.COMP_OCP_EXPRESS, const.COMP_OBAGENT, const.COMP_OBLOGPROXY, const.COMP_OBBINLOG_CE]
    }
    be_depends = {
