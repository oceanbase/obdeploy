...
def init(plugin_context, workflow, *args, **kwargs):
    ...
    workflow.add_with_kwargs(const.STAGE_FIRST, {'only_generate_password': True}, 'generate_config_pre', 'generate_password')
    ...
    workflow.add(const.STAGE_SECOND, 'init_pre', 'init')
