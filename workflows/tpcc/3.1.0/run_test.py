...
def run_test(plugin_context, workflow, *args, **kwargs):
    repository = None
    ...
    workflow.add_with_component_version_kwargs(const.STAGE_FIRST, 'tpcc', target_repository_version, {"repository": repository}, 'run_test')
