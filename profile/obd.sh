...
function _obd_complete_func
{
  ...
  all_cmds["obd cluster tenant"]="create drop show create-standby switchover failover decouple optimize set-backup-config set-sync-mode backup restore backup-show restore-show backup-cancel restore-cancel switch-log-source recover"
  ...
  all_cmds["obd cluster tenant set-sync-mode"]="_obd_reply_deploy_names"
