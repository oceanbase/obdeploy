...
function _obd_complete_func
{
  ...
  all_cmds["obd"]="mirror cluster test update repo demo web obdiag display-trace binlog license pwd host"
  ...
  all_cmds["obd cluster tenant"]="create drop show create-standby switchover failover decouple optimize set-backup-config backup restore backup-show restore-show backup-cancel restore-cancel"
  ...
  all_cmds["obd obdiag gather"]="all log clog slog obproxy_log perf plan_monitor stack sysstat scene ash"
